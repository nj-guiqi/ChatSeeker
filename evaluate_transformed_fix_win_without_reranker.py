...
def embedding_data(args):
    ...
    for path in os.listdir(data_base_path):
        if path.endswith(".json"):
            ...
            collection_name = f"bge_m3_fix_win_{conv_data_name}_without_reranker"
...
def evaulate_tranformed_data(args):
    ...
    for i, (eval_data_path, map_data_path) in enumerate(zip(eval_data_list, map_data_list)):
        colleaction_name = f"bge_m3_fix_win_dynamic_conv_data_{i}_without_reranker"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--conv_data_path", type=str, default=r"D:\project\myproject\ChatSeeker\data\fix_win_conv_data_without_reranker", help="chunked data path")
    ...
    parser.add_argument("--results_path", type=str, default=r"D:\project\myproject\ChatSeeker\transformed_results_fix_win_without_reranker", help="results path")
