...
def evaulate_tranformed_data(args):
    ...
    for i, (eval_data_path, map_data_path) in enumerate(zip(eval_data_list, map_data_list)):
        colleaction_name = f"bge_m3_win_conv_data_{i}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--results_path", type=str, default=r"D:\project\myproject\ChatSeeker\transformed_results", help="results path")
    parser.add_argument("--win_size", type=int, default=2, help="length of hierarchical attention")
